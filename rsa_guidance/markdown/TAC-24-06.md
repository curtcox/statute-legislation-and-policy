...
## 1.  Is the facility a “vending facility,” as defined in 34 C.F.R. § 395.1(x) for purposes of
the RSVFP?8
...
## 2.  Is the vending facility supervised by the SLA and operated by a licensed blind
...
## 3.  Is the vending facility on Federal10 property or another type of property for which
...
## 4.  Is the State agency proposing to incur costs for the benefit of the RSVFP that are
...
## 5.  What type of expenditures are planned?
...
## 6.  Is the item to be purchased “equipment,” as that term is defined at 2 C.F.R. § 200.1?
...
## 7.  Has the VR agency requested, and received, prior written approval14 in accordance
...
## 1.  The State’s law allows RSVFP vending facilities to operate on State, county, and municipal
...
## 2.  Building on the facts of Example 1, two years into their business operation, Vendor A
...
## 3.  Building on the facts in Examples 1 and 2, Vendor A wants to add a kick plate to the walk-
...
## 4.  The SLA has an opportunity to open a food truck vending facility on the property of a
...
## 5.  Building on the facts in Example 4 above, prior to beginning operation as a food truck
...
## 6.  Building on the facts of Examples 4 and 5, the SLA and Vendor B have decided the food
...
## 7.  The SLA found an opportunity to open a vending facility in a strip mall where the prior
...
## 8.  Building on Example 7, Vendor C is pleased with how busy the cafe is after being open for
...
## 9.  Building on the facts in Examples 7 and 8, Vendor C has been operating for two years and
...
## 10. Building on the facts in Example 7 and 8, Vendor C has been operating the cafe for 10
...
## 11. A private landowner has approached the SLA to initiate conversations about selling land to
...
## 12. The State owns land that could serve as a potential site for a thriving RSVFP vending
...
## 13. A private landowner approaches the SLA with an offer to sell land, including some
...
## 14. The SLA has been managing a snack bar in a Federal building for many years and has
...
## 15. This example provides information about how RSA could determine based on the facts
